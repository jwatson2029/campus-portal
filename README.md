...
Search for **"Studently"** in the [Chrome Web Store](https://chrome.google.com/webstore) and click **Add to Chrome**.
...
This extension **does not collect, transmit, or store any personal data**. All grade data is processed locally in your browser and never leaves your device. No data is persisted between sessions.
